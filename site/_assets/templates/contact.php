<main class="site-content">
	<section class="wrapper site-content-top column">
		<div class=" column-half">
			<div class="contents">
				<? echo $content; ?>
			</div>
		</div>
		<div class=" column-half form-space">
			<div class="contents">
				...
				<form method="post" action="/_assets/mail.php" id="form" name="form" class="form">
					...
					<div class="form-group">
						<div class="g-recaptcha" data-sitekey="6LdRzBATAAAAAOOx48ooaAw4T-TYn5gG5OLt84kO" data-callback="capenable" data-expired-callback="capdisable"></div>
					</div>
